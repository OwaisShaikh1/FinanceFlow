...
const features = [
  ...
  { icon: <BookOpen />, title: "Income & Expense Tracking", tag: "Accounting", description: "Automated transaction categorization with receipt attachment and bank reconciliation.", route: "/income-expense" },
  { icon: <FileText />, title: "GST-Compliant Invoicing", tag: "Billing", description: "Generate professional invoices with automatic GST calculations and e-way bill support.", route: "/gst-invoicing" },
  ...
  { icon: <Briefcase />, title: "Tax Management", tag: "Tax & Compliance", description: "GST filing assistant, TDS calculator, and income tax estimation tools.", route: "/tax-management" },
  ...
  { icon: <Layers />, title: "Chart of Accounts", tag: "Accounting", description: "Manage assets, liabilities, income, and expenses with detailed journal entries.", route: "/chart-of-accounts" },
  { icon: <Repeat />, title: "Bank Reconciliation", tag: "Accounting", description: "Automated matching of bank transactions with recorded data and CSV imports.", route: "/bank-reconciliation" },
